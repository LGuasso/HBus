...
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> implements RecyclerViewOnClickListenerHack {
    ...
    public CursorRecyclerViewAdapter(Context context, Cursor cursor) {
        ...
        mRowIdColumn = mDataValid ? mCursor.getColumnIndex(CompanyContract.Company._ID) : -1;
    ...
    public String getStringItemId(int position) {
        if (mDataValid && mCursor != null && mCursor.moveToPosition(position)) {
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (mCursor != null) {
            ...
            mRowIdColumn = newCursor.getColumnIndexOrThrow(CompanyContract.Company._ID);
            mDataValid = true;
