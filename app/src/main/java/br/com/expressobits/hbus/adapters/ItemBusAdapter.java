...
public class ItemBusAdapter extends RecyclerView.Adapter<ItemBusAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, final int i) {
        ...
        final Alarm alarm = alarmDAO.getAlarm(listBus.get(i).getId());
        ...
        myViewHolder.imageViewAlarm.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Alarm alarm1 = alarmDAO.getAlarm(listBus.get(i).getId());
                if (alarm1 != null) {
                    alarmDAO.delete(listBus.get(i).getId());
                    ...
                    alarm.setId(listBus.get(i).getId());
                    ...
                    alarm.setTimeAlarm(TextUtils.getTimeWithDelayTime(listBus.get(i).getTime(), alarm.getMinuteDelay()));
